      ...
      return renderer.create('<div class="note-color-palette"/>', function ($node, options) {
        ...
        for (var row = 0, rowSize = options.colors.length; row < rowSize; row++) {
          ...
          for (var col = 0, colSize = colors.length; col < colSize; col++) {
            ...
            buttons.push(['<button type="button" class="note-color-btn"', 'style="background-color1', color, '" ', 'data-event="', eventName, '" ', 'data-value="', color, '" ', 'title="', colorName, '" ', 'aria-label="', colorName, '" ', 'data-toggle="button" tabindex="-1"></button>'].join(''));
          }
