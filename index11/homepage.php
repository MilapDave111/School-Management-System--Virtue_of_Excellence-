...
<?php include("header.php") ?>    
    ...
    <nav class="navbar navbar-expand-lg  ">
        <a href="index.html" class="navbar-brand d-flex align-items-center px-2 px-lg-2">
            <img src="file:///C:/xampp/htdocs/Virtue_of_Excellence/index11/img/logo.jpg" alt="logo">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="index.html" class="nav-item nav-link active"style="color:#03285e"><b>Home</b></a>
                <a href="about.html" class="nav-item nav-link" style="color:#03285e"><b>About</b></a>
                <a href="courses.html" class="nav-item nav-link" style="color:#03285e"><b>Courses</b></a>
                
                <a href="contact.html" class="nav-item nav-link" style="color:#03285e"><b>Contact</b></a>
            </div>
           <?php if(isset($_SESSION['login'])) { ?>
                ...
                <ul class="dropdown-menu dropdown-menu-end"
                  ...
                  <li>
                    <a class="dropdown-item" href="http://localhost/Virtue_of_Excellence/admin/dashboard.php">Dashboard</a>
                  </li>
                  <li>
              ...
              <?php } else { ?>
                  <a href="../login.php" class="nav-link" style="color:#03285e"><i class="fa fa-user mr-2" style="color:#03285e"></i> <b>login</b></a>
                  <?php } ?>
            </div>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                ...
                                <a href="" class="btn text-white py-md-3 px-md-5 me-3 animated slideInLeft" style="background-color:#468ef3;">Read More</a>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <a href="" class="btn text-white py-md-3 px-md-5 me-3 animated slideInLeft" style="background-color:#03285e;">Read More</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="course-item bg-light">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./dist/uploads/<?php echo $course->image?>" >
                        ...
                        <div class="text-center p-4 pb-0">
                            <h3 class="mb-0">Price:</b> 5000 INR </h3>
                            <div class="mb-3">
                            ...
                            <h5 class="mb-4"><?php echo $course->name?></h5>
                        </div>
                        <div class="d-flex border-top">
                            
                            <small class="flex-fill text-center border-end py-2"><i class="fa fa-clock text-primary me-2"></i>Duration:</b><?php echo $course->duration?></small>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title  text-center  px-3"  style="color:#468ef3" >Instructors</h6>
                <h1 class="mb-5" style="color:#03285e;">Expert Instructors</h1>
            </div>
            <div class="row g-4">
