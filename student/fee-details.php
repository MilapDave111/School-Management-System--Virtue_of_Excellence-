            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo $action?>" method="post" name="payuForm">
                        <input type="hidden" name="surl" value="http://localhost/sms/actions/success.php" size="64" />
        
		                <input type="hidden" name="furl" value="http://localhost/sms/actions/failure.php" size="64" />
